...
namespace cv {
    ...
    public:
        ...
        CV_WRAP virtual int getTrainIncr() const = 0;
        CV_WRAP virtual void setTrainIncr(double incr) = 0;
        CV_WRAP virtual int getTrainDecr() const = 0;
        CV_WRAP virtual void setTrainDecr(double decr) = 0;
        CV_WRAP virtual int getVarThreshold() const = 0;
        CV_WRAP virtual void setVarThreshold(double thr) = 0;
        CV_WRAP virtual int getVarWatermark() const = 0;
        CV_WRAP virtual void setVarWatermark(double mark) = 0;
        CV_WRAP virtual int getVarUpWatermark() const = 0;
    ...
    //CV_EXPORTS_W Ptr<BackgroundSubtractorWIS> createBackgroundSubtractorWIS(int _nobits=4, int _notics=128);
